...
public class MyRecyclerVewAdapter {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, final int position) {
        ...
        UserResponse currentUserBeingPopulated = userArrayList.get(position);
